...
hdf5_variable_path = f"/home/taq/taq_variables/{args.year}{args.month}_var_MSFTIBM_prof.h5"
print(f"Output HDF5 file path: {hdf5_variable_path}")

def main():
    # Prepare datasets
    trades, Buys_trades, Sells_trades, Ask, Bid = prepare_datasets(
        args.hdf5_file_path,
        args.base_date,
        args.stock_name,
        args.year,
    ...
    # Volume weighted average pre/post-trade bid/ask prices (measured just before each trade and weighted by the size of each trade)
    # backward merger
