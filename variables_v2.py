...
hdf5_variable_path = f"/home/taq/taq_variables/{args.year}{args.month}_IBM.h5"
...
if not Sells_trades.empty:
    aggr_sells_1min = Sells_trades.resample("1min", on="time").apply(
        custom_agg_function
    )
...
if not Sells_trades.empty:
    vwap_sells_1min = Sells_trades.resample("1min", on="time").apply(
        custom_agg_function
    )
...
if not trades.empty:
    ...
    average_trades_1min.rename(columns={"price": "av_PRICE_TRADE_6"}, inplace=True)
...
if not Buys_trades.empty:
    ...
    average_buys_1min.rename(columns={"price": "av_PRICE_BUY_6"}, inplace=True)
...
if not Sells_trades.empty:
    ...
    average_sells_1min.rename(columns={"price": "av_PRICE_SELL_6"}, inplace=True)
...
if not trades.empty:
    ...
    twap_trades.rename(
        columns={"TWAP": "TWAP_trades_8", "TWAV": "TWAV_TRADE_8"},
        inplace=True,
    )
...
if not Ask.empty:
    ...
    twap_asks.rename(
        columns={"TWAP": "TWAP_asks_8", "TWAV": "TWAV_ASK_8"},
        inplace=True,
    )
...
if not Bid.empty:
    ...
    twap_bids.rename(
        columns={"TWAP": "TWAP_bids_8", "TWAV": "TWAV_BID_8"},
        inplace=True,
    )
...
if not Sells_trades.empty:
    Sells_trades_resampled = Sells_trades.resample("1min", on="time").agg(
        {"vol": "sum"}
    )
if not Ask.empty:
...
if not trades.empty:
    ...
    trades_changes.rename(
        columns={"price": "no_dP_TRADE_10", "vol": "no_dV_TRADE_10"},
        inplace=True,
    )
...
if not Ask.empty:
    ...
    Ask_changes.rename(
        columns={"price": "no_dP_ASK_10", "vol": "no_dV_ASK_10"},
        inplace=True,
    )
...
if not Bid.empty:
    ...
    Bid_changes.rename(
        columns={"price": "no_dP_BID_10", "vol": "no_dV_BID_10"},
        inplace=True,
    )
...
dfs_to_merge = []
try:
    if not trades_1min_after_930.empty:
        dfs_to_merge.append(trades_1min_after_930)
except NameError:
    pass

try:
    if not asks_1min_after_930.empty:
        dfs_to_merge.append(asks_1min_after_930)
except NameError:
    pass

try:
    if not bids_1min_after_930.empty:
        dfs_to_merge.append(bids_1min_after_930)
except NameError:
    pass

try:
    if not aggr_buys_1min_after_930.empty:
        dfs_to_merge.append(aggr_buys_1min_after_930)
except NameError:
    pass

try:
    if not aggr_sells_1min_after_930.empty:
        dfs_to_merge.append(aggr_sells_1min_after_930)
except NameError:
    pass

try:
    if not vwap_trades_1min_after_930.empty:
        dfs_to_merge.append(vwap_trades_1min_after_930)
except NameError:
    pass

try:
    if not vwap_buys_1min_after_930.empty:
        dfs_to_merge.append(vwap_buys_1min_after_930)
except NameError:
    pass

try:
    if not vwap_sells_1min_after_930.empty:
        dfs_to_merge.append(vwap_sells_1min_after_930)
except NameError:
    pass

try:
    if not average_trades_1min_after_930.empty:
        dfs_to_merge.append(average_trades_1min_after_930)
except NameError:
    pass

try:
    if not average_buys_1min_after_930.empty:
        dfs_to_merge.append(average_buys_1min_after_930)
except NameError:
    pass

try:
    if not average_sells_1min_after_930.empty:
        dfs_to_merge.append(average_sells_1min_after_930)
except NameError:
    pass
...
try:
    if not twap_trades_after_930.empty:
        dfs_to_merge.append(twap_trades_after_930)
except NameError:
    pass

try:
    if not twap_asks_after_930.empty:
        dfs_to_merge.append(twap_asks_after_930)
except NameError:
    pass

try:
    if not twap_bids_after_930.empty:
        dfs_to_merge.append(twap_bids_after_930)
except NameError:
    pass

try:
    if not trades_resampled_after_930.empty:
        dfs_to_merge.append(trades_resampled_after_930)
except NameError:
    pass

try:
    if not trades_changes_after_930.empty:
        dfs_to_merge.append(trades_changes_after_930)
except NameError:
    pass

try:
    if not Ask_changes_after_930.empty:
        dfs_to_merge.append(Ask_changes_after_930)
except NameError:
    pass

try:
    if not Bid_changes_after_930.empty:
        dfs_to_merge.append(Bid_changes_after_930)
except NameError:
    pass
